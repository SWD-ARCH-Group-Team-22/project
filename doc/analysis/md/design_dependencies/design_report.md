...
However, this domain is also one of the most central parts of the system. The map view. The map view needs information from styles, filters, text, links, icons, UI listeners and the map model. This creates high fan-out, meaning many outgoing links to other packages. It is understandable, because a visual node contains many elements, but it also increases cognitive load: modifying this area requires understanding several connected classes and subsystems.
...
The co-change relation suggested that the public API and the scripting plugin evolve together. The code confirms this relation, but (it happens?)in a controlled way. Scripts do not access the internal model directly; they pass through proxy classes. `NodeProxy` exposes the node API while internally working with `NodeModel`. Similarly, `MapProxy` exposes `MindMap` while working with `MapModel`.
...
#TO-DO (?) insert a short relation? it can be useful or just repetes concepts explain at the begginning?
### 1. Composite Pattern
...
### Structure Diagram
<p align="center">
  <img src="" alt="comment" width="700"/>
</p>

<p align="center"><em>Figure 8: comment.</em></p>
...
<p align="center"><em>Figure 9: comment.</em></p>
...
<p align="center"><em>Figure 10: comment.</em></p>
...
<p align="center"><em>Figure 11: comment.</em></p>
...
<p align="center"><em>Figure 12: comment.</em></p>
...
<p align="center"><em>Figure 13: comment.</em></p>
### 4. Strategy Pattern
...
<p align="center"><em>Figure 14: comment.</em></p>
