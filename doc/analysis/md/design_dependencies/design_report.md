...
<p align="center"><em>Figure 15: comment.</em></p>
...
The selected patterns also show that Freeplane often uses pragmatic variants rather than textbook structures. Composite is simplified in `NodeModel`; Builder keeps dynamic construction safer; Strategy separates matching algorithms; Proxy protects the core model. Overall, Freeplane’s design is modular and coherent, but the graphical map view, outline-to-map synchronisation and scripting proxy layer are the areas where future changes require the most system knowledge.

molto corto... valutiamo questo anche 
